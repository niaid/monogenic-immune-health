## Clean and format testing TBNKs, selecting the desired samples and features, 
## adding in the neutrophil lymphocyte ratio (NLR) manual. Creates subject and sample level esets.
