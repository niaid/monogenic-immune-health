...
![](tbnks_qc_testing_files/figure-markdown_github/unnamed-chunk-3-1.png)
...
![](tbnks_qc_testing_files/figure-markdown_github/unnamed-chunk-4-1.png)

    ## Warning: Removed 5 rows containing missing values (geom_text).

![](tbnks_qc_testing_files/figure-markdown_github/unnamed-chunk-4-2.png)

    ## Warning: Removed 5 rows containing missing values (geom_text).

![](tbnks_qc_testing_files/figure-markdown_github/unnamed-chunk-4-3.png)

    ## Warning: Removed 5 rows containing missing values (geom_text).

![](tbnks_qc_testing_files/figure-markdown_github/unnamed-chunk-4-4.png)
